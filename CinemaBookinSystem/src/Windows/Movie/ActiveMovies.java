...
public class ActiveMovies extends JFrame {
	...
	private void getData() {
		ArrayList<Movie> halls = DbAdapterMovie.selectMoviesActive();
		if (halls.size() > 0) {
	...
	public ActiveMovies() {
		...
		JLabel lblRepertuar = new JLabel("DOSTĘPNE FILMY");
		lblRepertuar.setBounds(276, 11, 264, 37);
		...
		JButton btnNewButton = new JButton("SZCZEGÓŁY");
		...
		btnNewButton.setBackground(new Color(204, 0, 153));
		btnNewButton.setBounds(0, 64, 356, 45);
		panel_3.add(btnNewButton);

		JButton btnRezerwuj = new JButton("WSTECZ");
		btnRezerwuj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		btnRezerwuj.setForeground(Color.BLACK);
		btnRezerwuj.setFont(new Font("Tahoma", Font.BOLD, 20));
		btnRezerwuj.setBackground(new Color(204, 0, 153));
		btnRezerwuj.setBounds(0, 206, 356, 45);
		panel_3.add(btnRezerwuj);
		generateGrid();
	}
}